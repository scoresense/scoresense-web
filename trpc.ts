...
@layer components {
  ...
  /* Cards */
  .card {
    @apply rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200;
  }

  .card-elevated {
    @apply rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow duration-200;
  }
  ...
  .shadow-glow-lg {
    @apply shadow-2xl shadow-cyan-500/30;
  }
}
